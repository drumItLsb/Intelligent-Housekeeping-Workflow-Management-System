...
public class ApiExceptionHandler {
    ...
    @ExceptionHandler(SummaryFetchException.class)
    public ResponseEntity<ErrorResponseDTO> handleSummaryFetch(
            SummaryFetchException ex,
            HttpServletRequest req
    ) {
        ErrorResponseDTO response = new ErrorResponseDTO(
                Instant.now().toString(),
    ...
    @ExceptionHandler(AssignmentMappingFetchException.class)
    public ResponseEntity<ErrorResponseDTO> handleAssignmentMappingFetch(
            AssignmentMappingFetchException ex,
            HttpServletRequest req
    ) {
        ErrorResponseDTO response = new ErrorResponseDTO(
                Instant.now().toString(),
